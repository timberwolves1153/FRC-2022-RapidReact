...
public class OneBallGatekeepHangarRightAutoGroup extends SequentialCommandGroup {
  /** Creates a new OneBallGatekeepHangarRight. */
  public OneBallGatekeepHangarRightAutoGroup(
